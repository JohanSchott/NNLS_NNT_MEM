*> \brief \b dlasdtquad creates a tree of subproblems for bidiagonal divide and conquer. Used by sbdsdc.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download dlasdtquad + dependencies 
...
*  ===========
*
*       SUBROUTINE dlasdtquad( N, LVL, ND, INODE, NDIML, NDIMR, MSUB )
* 
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> dlasdtquad creates a tree of subproblems for bidiagonal divide and
*> conquer.
*> \endverbatim
*
*  Arguments:
