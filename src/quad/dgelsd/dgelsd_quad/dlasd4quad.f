*> \brief \b dlasd4quad computes the square root of the i-th updated eigenvalue of a positive symmetric rank-one modification to a positive diagonal matrix. Used by dbdsdc.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download dlasd4quad + dependencies
...
*  ===========
*
*       SUBROUTINE dlasd4quad( N, I, D, Z, DELTA, RHO, SIGMA, WORK, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            I, INFO, N
*       real*16   RHO, SIGMA
...
*> \param[in] Z
*> \verbatim
*>          Z is real*16 array, dimension ( N )
*>         The components of the updating vector.
*> \endverbatim
*>
*> \param[out] DELTA
*> \verbatim
*>          DELTA is real*16 array, dimension ( N )
...
*> \param[out] WORK
*> \verbatim
*>          WORK is real*16 array, dimension ( N )
...
*     .. Parameters ..
      INTEGER            MAXIT
      PARAMETER          ( MAXIT = 400 )
      real*16   ZERO, ONE, TWO, THREE, FOUR, EIGHT, TEN
      PARAMETER          ( ZERO = 0.0q0, ONE = 1.0q0, TWO = 2.0q0,
     $                   THREE = 3.0q0, FOUR = 4.0q0, EIGHT = 8.0q0,
     $                   TEN = 10.0q0 )
*     ..
*     .. Local Scalars ..
      LOGICAL            ORGATI, SWTCH, SWTCH3, GEOMAVG
      INTEGER            II, IIM1, IIP1, IP1, ITER, J, NITER
      real*16   A, B, C, DELSQ, DELSQ2, SQ2, DPHI, DPSI, DTIIM,
...
*     .. External Subroutines ..
      EXTERNAL           dlaed6quad, dlasd5quad
*     ..
*     .. External Functions ..
      real*16   dlamchquad
      EXTERNAL           dlamchquad
...
*
      ...
      END IF
      IF( N.EQ.2 ) THEN
         CALL dlasd5quad( I, D, Z, DELTA, RHO, SIGMA, WORK )
         RETURN
      END IF
*
...
*
     ...
     $             ( D( IIP1 )-D( IIM1 ) )*( D( IIM1 )+D( IIP1 ) )*TEMP1
            ...
            DD( 3 ) = DTIIP
            CALL dlaed6quad( NITER, ORGATI, C, DD, ZZ, W, ETA, INFO )
*
            IF( INFO.NE.0 ) THEN
*
*              If INFO is not 0, i.e., dlaed6quad failed, switch back 
...
*
               IF( INFO.NE.0 ) THEN
*
*                 If INFO is not 0, i.e., dlaed6quad failed, switch 
