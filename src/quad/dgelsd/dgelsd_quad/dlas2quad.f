*> \brief \b dlas2quad computes singular values of a 2-by-2 triangular matrix.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download dlas2quad + dependencies 
...
*  ===========
*
*       SUBROUTINE dlas2quad( F, G, H, SSMIN, SSMAX )
* 
*       .. Scalar Arguments ..
*       real*16   F, G, H, SSMAX, SSMIN
*       ..
*  
*
*> \par Purpose:
...
*> \verbatim
*>
*> dlas2quad  computes the singular values of the 2-by-2 matrix
*>    [  F   G  ]
*>    [  0   H  ].
...
*     ..
*     .. Local Scalars ..
      real*16   AS, AT, AU, C, FA, FHMN, FHMX, GA, HA
*     ..
*     .. Intrinsic Functions ..
