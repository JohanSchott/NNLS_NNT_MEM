*> \brief \b dlasetquad initializes the off-diagonal elements and the diagonal elements of a matrix to given values.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download dlasetquad + dependencies 
...
*  ===========
*
*       SUBROUTINE dlasetquad( UPLO, M, N, ALPHA, BETA, A, LDA )
* 
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            LDA, M, N
...
*> \verbatim
*>
*> dlasetquad initializes an m-by-n matrix A to BETA on the diagonal and
