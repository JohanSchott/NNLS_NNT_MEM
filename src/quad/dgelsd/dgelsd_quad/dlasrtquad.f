*> \brief \b dlasrquadT sorts numbers in increasing or decreasing order.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download dlasrquadT + dependencies 
...
*  ===========
*
*       SUBROUTINE dlasrquadT( ID, N, D, INFO )
* 
*       .. Scalar Arguments ..
*       CHARACTER          ID
*       INTEGER            INFO, N
...
*
*  =====================================================================
      SUBROUTINE dlasrtquad( ID, N, D, INFO )
*
...
*
      INFO = 0
      DIR = -1
      IF( lsamequad( ID, 'D' ) ) THEN
         DIR = 0
      ELSE IF( lsamequad( ID, 'I' ) ) THEN
         DIR = 1
      END IF
      IF( DIR.EQ.-1 ) THEN
         INFO = -1
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL xerblaquad( 'dlasrtquad', -INFO )
         RETURN
      END IF
*
